...
function submitBooking() {
        ...
        const startDate = document.getElementById('tanggal_rental').value;
        const endDate = document.getElementById('tanggal_selesai').value;

      
        if (!productId || !startDate || !endDate) {
            alert("Data sewa belum lengkap!");
            return;
        }
        ...
        const baseUrl = "{{ route('booking.create') }}";
        const url = `${baseUrl}?product_id=${productId}&start_date=${startDate}&end_date=${endDate}`;
